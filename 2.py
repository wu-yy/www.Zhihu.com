...
def create_session():
    ...
    header={
        'User-Agent':'Mozilla/5.0(Windows NT 6.1;WOW64) AppleWebKit/537.36 (KHTML,like Gecko ) Chrome/43.0.23357.124 Safari/537.36',
        'Host':'www.zhihu.com',
        'Referer':'http://www.zhihu.com/'

    }

    r=session.post('http://www.zhihu.com/login/email',data=login_data,header=header)
    if r.json()['r']==1:
        ...
        if has_cookies is False:
            raise (ValueError('请填写config.ini 文件中的cookie 项目'))
        else:
